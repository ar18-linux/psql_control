...
psql_install_dir="${my_install_dir}/${psql_sub_dir}"

ar18.script.execute_with_sudo rm -rf "${psql_install_dir}"
cd "${psql_src_dir}"
...
make -j"${threads}"
ar18.script.execute_with_sudo make install
